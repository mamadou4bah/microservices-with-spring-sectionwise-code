...
```
- Make sure docker server is up and running in your machine. Now run the docker command **"docker build . -t mamadou4bah/accounts"** from the location where **Dockerfile** is
